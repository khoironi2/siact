                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body pb-0 px-4 pt-4">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="mb-1">47</h5>
                                        <span class="text-success">Total Banjir</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                        <div class="card bg-success	overflow-hidden">
                            <div class="card-body pb-0 px-4 pt-4">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="text-white mb-1">140</h5>
                                        <span class="text-white">Total Gempabumi</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                        <div class="card overflow-hidden">
                            <div class="card-body px-4 py-4">
                                <h5 class="mb-3">767 / <small class="text-primary">Status Bencana</small></h5>
                                <div class="chart-point">
                                    <div class="check-point-area">
                                        <canvas id="ShareProfit2"></canvas>
                                    </div>
                                    <ul class="chart-point-list">
                                        <li><i class="fa fa-circle text-primary mr-1"></i> 40% Tanah longsor</li>
                                        <li><i class="fa fa-circle text-success mr-1"></i> 35% Gempabumi</li>
                                        <li><i class="fa fa-circle text-warning mr-1"></i> 25% Banjir</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <h4 class="card-title">Operasi Tanggap Darurat</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-responsive-sm mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><b>2</b></td>
                                                <td>Banjir KalBar dan KalSel</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><b>4</b></td>
                                                <td>Sriwijaya Air S-j182</td>
                                                <td>9 Januari 2021</td>
                                                <td class="recent-stats d-flex align-items-center"><i class="fa fa-circle text-danger mr-1"></i>Selesai</td>
                                                <td>
                                                    <a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                    <a href="#" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                </td>
            ...
            <div class="col-xl-3 col-xxl-4 col-lg-12 col-md-12">
                <div class="card bg-primary text-white">
                    <div class="card-header pb-0 border-0">
                        <h4 class="card-title text-white">RELAWAN AKTIF</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media mr-2">
                                            <img alt="image" width="50" src="<?= base_url('assets/') ?>images/avatar/r2.png">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mb-1 text-white">Dr Sultad</h5>
                                            <small class="d-block">29 Desember 2020 - 02:26 PM</small>
                                        </div>
                                        <div class="dropdown">
                                ...
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media mr-2 media-info">
                                            <img alt="image" width="50" src="<?= base_url('assets/') ?>images/avatar/r1.png">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mb-1 text-white">Restu Wijaya</h5>
                                ...
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media mr-2 media-success">
                                            <img alt="image" width="50" src="<?= base_url('assets/') ?>images/avatar/r3.png">
                                            <i class="fa fa-home"></i>
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mb-1 text-white">Desi Suminah</h5>
                                            <small class="d-block">29 July 2020 - 02:26 PM</small>
                                        </div>
                                        <div class="dropdown">
            ...
            <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                <div class="card bg-info activity_overview">
                    <div class="card-header  border-0 pb-3 ">
                        <h4 class="card-title text-white">Aktivitas</h4>
                    </div>
                    <div class="card-body pt-0">
                        <div class="custom-tab-1">
                            <ul class="nav nav-tabs mb-2">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#sale">Relawan</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="col-xl-6 col-xxl-12 col-lg-12 col-md-12">
                <div id="user-activity" class="card">
                    <div class="card-header border-0 pb-0 d-sm-flex d-block">
                        <div>
                            <h4 class="card-title">History 2015 - 2020</h4>
                            <p class="mb-1">Jumlah bencana yang terjadi pada kurun waktu tertentu</p>
                        </div>
