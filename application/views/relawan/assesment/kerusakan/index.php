						...
						<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
							<div class="card">
								<div class="card-header border-0 pb-0">
									<h4 class="card-title">ASSESMENT KERUSAKAN</h4>
									<a href="<?= base_url('relawan/assesment/kerusakan/add') ?>">
										...
										<table class="table table-responsive-sm mb-0">
											<thead>
												<tr>
													...
													<th><strong>JENIS BANGUNAN</strong></th>
											...
											<tbody>
												<tr>
													...
													<td class="recent-stats d-flex align-items-center"><i class="fa fa-circle text-danger mr-1"></i>BERAT</td>
													<td>
