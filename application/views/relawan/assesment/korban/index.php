						...
						<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
							<div class="card">
								<div class="card-header border-0 pb-0">
									<h4 class="card-title">ASSESMENT JUMLAH KORBAN</h4>
									<a href="<?= base_url('relawan/assesment/korban/add') ?>">
										...
										<table class="table table-responsive-sm mb-0">
											<thead>
												<tr>
													...
													<th><strong>DISABILITAS</strong></th>
											...
											<tbody>
												<tr>
													...
													<td>32 TAHUN</td>
													<td>TIDAK</td>
													<td class="recent-stats d-flex align-items-center"><i class="fa fa-circle text-success mr-1"></i>LUKA RINGAN</td>
												...
												<tr>
													...
													<td><b>1</b></td>
													<td>MINGGUS KOWARAI</td>
													<td>98932322</td>
													<td>PRIA</td>
													<td>29 TAHUN</td>
													<td>TIDAK</td>
													<td class="recent-stats d-flex align-items-center"><i class="fa fa-circle text-danger mr-1"></i>LUKA BERAT</td>
													<td><a target="_blank" href="https://www.google.com/maps/place/Kabupaten+Mamuju,+Sulawesi+Barat/@-2.5516186,118.690739,9z/data=!3m1!4b1!4m5!3m4!1s0x2d8d73d9fc68ade1:0x1c96835f41d7a64f!8m2!3d-2.4920057!4d119.3250347">Kabupaten Mamuju</a> </td>
													<td>
														<a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
														<a href="#" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
