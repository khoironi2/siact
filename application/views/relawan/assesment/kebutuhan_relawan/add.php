	                                ...
	                                <div class="basic-form">
	                                    <form>
	                                        <div class="form-group">
	                                            <label>ALAT TIDUR</label>
	                                            <input type="text" class="form-control input-rounded " placeholder="9000 UNIT">
	                                        </div>
	                                        <div class="form-group">
	                                            <label>JAS HUJAN</label>
	                                            <input type="text" class="form-control input-rounded " placeholder="28000 UNIT">
	                                        </div>
	                                        <div class="form-group">
	                                            <label>HELM</label>
	                                            <input type="text" class="form-control input-rounded " placeholder="28000 UNIT">
	                                        ...
	                                        <div class="form-group mt-5">
	                                            <a href="<?= base_url('relawan/assesment/kebutuhan_relawan') ?>">
