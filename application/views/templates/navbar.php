                ...
                <div class="tab-pane chart-sidebar fade show active" role="tabpanel">
                    <div class="card">
                        <div class="card-header align-items-start">
                            <div>
                                <h6>Kehadiran</h6>
                                <p>Persentase kehadiran setiap bulan</p>
                            </div>
                    ...
                    <div class="card bg-warning-light">
                        <div class="card-header align-items-start mb-3">
                            <div>
                                <h6>Penelitian</h6>
                                <p>Indeks persentase penelitian</p>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="chart-point">
                                ...
                                <ul class="chart-point-list">
                                    <li style="font-size: small;"><i class="fa fa-circle text-primary mr-1"></i> 40% </li>
                                    <li><i class="fa fa-circle text-success mr-1"></i> 35% </li>
                                    <li><i class="fa fa-circle text-warning mr-1"></i> 25% </li>
                                </ul>
                            </div>
                            <ul class="chart-point-list">
                                <li style="font-size: small;"><i class="fa fa-circle text-primary mr-1"></i> Internasional</li>
                                <li><i class="fa fa-circle text-success mr-1"></i> Nasional Akreditasi</li>
                                <li><i class="fa fa-circle text-warning mr-1"></i> Nasional Tidak Akreditasi</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="<?= base_url('assets/dosen/') ?>images/profile/<?= $account->gambar_users; ?>" width="20" alt="" />
