    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?= base_url('komandan/dashboard') ?>" class="brand-logo">
                <img class="logo-abbr" src="<?= base_url('assets/') ?>images/Binis-Digital-Akbara.png" alt="">
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?= base_url('assets/') ?>images/avatar/1.jpg" class="rounded-circle user_img" alt="" />
                            ...
                            <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
                                        <img src="<?= base_url('assets/') ?>images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="" />
                                    </div>
            ...
            <div class="fixed-content-body dz-scroll" id="DZ_W_Fixed_Contant">
                <div class="tab-content" id="menu">
                    ...
                    <div class="tab-pane fade" id="apps">
                        <ul class="metismenu tab-nav-menu">
                            <li class="nav-label">ASSESMENT</li>
                            <li>
                                <a class="has-arrow" href="<?= base_url('relawan/assesment/kaji_cepat') ?>" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                                    ...
                                    <span class="nav-text">Kaji Cepat</span>
                                </a>
                            </li>
                            <li><a class="has-arrow" href="penilaiankebutuhanmasyarakat.html" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                                    ...
                                    <span class="nav-text">Penilain Kebutuhan</span>
                                </a>
                                <ul aria-expanded="false">
                                    <li><a href="<?= base_url('relawan/assesment/kebutuhan_masyarakat') ?>">KEBUTUHAN MASYARAKAT</a></li>
                                    <li><a href="<?= base_url('relawan/assesment/kebutuhan_relawan') ?>">KEBUTUHAN RELAWAN</a></li>
                                </ul>
                            </li>
                            <li><a class="has-arrow" href="<?= base_url('relawan/assesment/kerusakan') ?>" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                                            <path d="M4.00246329,12.2004927 L13,14 L13,4.06189375 C16.9463116,4.55399184 20,7.92038235 20,12 C20,16.418278 16.418278,20 12,20 C7.64874861,20 4.10886412,16.5261253 4.00246329,12.2004927 Z" fill="#000000" opacity="0.3" />
                                    ...
                                    <span class="nav-text">Kerusakan Bangunan</span>
                                </a>
                            </li>
                            <li><a class="has-arrow" href="<?= base_url('relawan/assesment/korban') ?>" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                                            <path d="M4.00246329,12.2004927 L13,14 L13,4.06189375 C16.9463116,4.55399184 20,7.92038235 20,12 C20,16.418278 16.418278,20 12,20 C7.64874861,20 4.10886412,16.5261253 4.00246329,12.2004927 Z" fill="#000000" opacity="0.3" />
                                    ...
                                    <span class="nav-text">Jumlah Korban</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="tab-pane chart-sidebar fade show active" role="tabpanel">
                    <div class="card">
                        <div class="card-header align-items-start">
                            <div>
                                <h6>BENCANA</h6>
                                <p>Persentase kejadian bencana alam per bulan</p>
                            </div>
                    ...
                    <div class="card bg-info-light">
                        <div class="card-header align-items-start mb-3">
                            <div>
                                <h6>JUMLAH RELAWAN</h6>
                                <p>Persentase Tim Siaga Tiap Daerah</p>
                            </div>
                        ...
                        <div class="card-body">
                            <p class="mb-2 d-flex"><img width="22" height="22" src="<?= base_url('assets/') ?>images/pmi.png" class="mr-2" alt="" />PUSAT
                            ...
                            <p class="mb-2 d-flex"><img width="22" height="22" src="<?= base_url('assets/') ?>images/pmi.png" class="mr-2" alt="" />PROVINSI
                            ...
                            <p class="mb-2 d-flex"><img width="22" height="22" src="<?= base_url('assets/') ?>images/pmi.png" class="mr-2" alt="" />DAERAH
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="<?= base_url('assets/') ?>images/avatar/r1.png" width="20" alt="" />
                                    <div class="header-info">
                                        <span>Hey, <strong><?= $account->nama_panggilan; ?></strong></span>
                                        <small><?= $account->nama_jabatan; ?></small>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
